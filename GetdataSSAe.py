...
plt.plot(tyr,ivol1[0],label='SSAe=0.3',linewidth=3)
plt.plot(tyr,ivol1[1],label='SSAe=0.65',linewidth=3)
plt.plot(tyr,ivol1[2],label='SSAe=1.0',linewidth=3)
...
plt.figure(figsize=(13,6))
plt.plot(tyr,iarea1[0],label='SSAe=0.3',linewidth=3)
plt.plot(tyr,iarea1[1],label='SSAe=0.65',linewidth=3)
plt.plot(tyr,iarea1[2],label='SSAe=1.0',linewidth=3)
